...
@SpringBootTest(classes = PostsApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
...
public class PostsApplicationTests implements ApplicationContextAware {
