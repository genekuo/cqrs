...
@SpringBootTest(classes = ConnectionsApplication.class, webEnvironment = WebEnvironment.DEFINED_PORT)
...
public class ConnectionsApplicationTests implements ApplicationContextAware {
